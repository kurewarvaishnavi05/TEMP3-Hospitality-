      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20 relative z-10">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-white/70 text-sm mb-8 leading-loose font-light">
            ...
            <ul className="flex flex-col gap-4 mb-10">
              <li className="flex items-center gap-3">
                ...
                <span className="text-[12px] uppercase tracking-widest text-[#d4b483] font-semibold">Meaningful Hospitality</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 bg-[#d4b483] rotate-45 shrink-0"></div>
                <span className="text-[12px] uppercase tracking-widest text-[#d4b483] font-semibold">Memorable Experiences</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 bg-[#d4b483] rotate-45 shrink-0"></div>
                <span className="text-[12px] uppercase tracking-widest text-[#d4b483] font-semibold">Modern Luxury</span>
              </li>
            </ul>
          ...
          <div className="flex flex-col lg:pl-8">
            <h4 className="text-[#d4b483] text-[12px] font-bold uppercase tracking-[0.2em] mb-4">Quick Links</h4>
            ...
            <div className="flex flex-col gap-5 items-start">
              <Link href="/" className="text-white/60 hover:text-white text-sm transition-all duration-300 hover:translate-x-2">Home</Link>
              <Link href="/about" className="text-white/60 hover:text-white text-sm transition-all duration-300 hover:translate-x-2">About Us</Link>
              <Link href="/rooms" className="text-white/60 hover:text-white text-sm transition-all duration-300 hover:translate-x-2">Signature Suites</Link>
              <Link href="/experiences" className="text-white/60 hover:text-white text-sm transition-all duration-300 hover:translate-x-2">Experiences</Link>
              <Link href="/dining" className="text-white/60 hover:text-white text-sm transition-all duration-300 hover:translate-x-2">Dining</Link>
            </div>
          </div>

          {/* Col 3: Contact */}
          <div className="flex flex-col lg:pl-4">
            <h4 className="text-[#d4b483] text-[12px] font-bold uppercase tracking-[0.2em] mb-4">Contact</h4>
            <div className="w-full flex items-center gap-2 mb-8 opacity-40">
              <div className="w-1.5 h-1.5 bg-[#d4b483] rotate-45"></div>
              <div className="h-px bg-white/20 flex-grow"></div>
            </div>
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4 group">
                ...
                <span className="text-white/70 text-sm leading-loose group-hover:text-white transition-colors duration-300">Paradise Island, Maldives<br/>99999</span>
              </div>
              <div className="flex items-center gap-4 group">
                <Mail size={14} className="text-[#d4b483] shrink-0 group-hover:scale-110 transition-transform duration-300" />
                <a href="mailto:corporate@aurahotels.com" className="text-white/70 text-sm hover:text-white transition-all duration-300 hover:translate-x-1">corporate@aurahotels.com</a>
              </div>
              <div className="flex items-center gap-4 group">
                <Phone size={14} className="text-[#d4b483] shrink-0 group-hover:scale-110 transition-transform duration-300" />
                <a href="tel:+18001234567" className="text-white/70 text-sm hover:text-white transition-all duration-300 hover:translate-x-1">+1 (800) 123-4567</a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start lg:items-end w-full">
            <Link href="/partner" className="w-full sm:w-64 flex items-center justify-between bg-[#f8f5f0] text-black px-6 py-4 mb-4 hover:bg-[#d4b483] transition-all duration-300 group shadow-lg hover:shadow-xl hover:-translate-y-1">
              <span className="text-[12px] font-bold tracking-[0.2em] uppercase">Partner</span>
            ...
            <Link href="/careers" className="w-full sm:w-64 flex items-center justify-between border border-[#d4b483] text-[#d4b483] px-6 py-4 mb-16 hover:bg-[#d4b483] hover:text-black transition-all duration-300 group shadow-lg hover:shadow-xl hover:-translate-y-1">
              <span className="text-[12px] font-bold tracking-[0.2em] uppercase">Careers</span>
              <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform duration-300" />
            </Link>
            
            <p className="text-white/40 text-[11px] leading-relaxed mb-4 text-left lg:text-right max-w-[280px]">
              &copy; {new Date().getFullYear()} Aura Hospitality & Entertainment LLP. All Rights Reserved.
            </p>
            <p className="text-white/40 text-[11px] leading-relaxed text-left lg:text-right max-w-[280px]">
